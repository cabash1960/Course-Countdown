...
function Benefits() {
  ...
  return (
    <section
      ref={ref}
      id="benefits"
      className={`relative  px-8 py-20 lg:px-16  min-h-screen
        transition-all duration-700 ease-out  bg-purple-500
        ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}
      `}
    >
      <div className="  max-w-7xl justify-center mx-auto items-center flex flex-col gap-10">
        <div
